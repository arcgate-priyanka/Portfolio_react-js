                    ...
                    <div class='grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4'>
                        ...
                        <div class="sm:col-span-2">
                            <div class='mt-2.5'>
                                ...
                                class='bg-[#161616] w-full px-4 py-4  text-gray-400 placeholder-gray-400
                                     border border-gray-400 rounded-md focus:outline-none focus:border-pink-600' rows='4'>
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            <button type="submit"
                            class="text-sl w-full p-4 mt-2 font-semibold text-white bg-primary-color rounded-md">
                                Send
                            </button>
